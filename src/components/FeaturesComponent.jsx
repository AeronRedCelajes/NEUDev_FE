    ...
    <>
        ...
        <div className='feature'>
            <div className='row g-2'>
                <div className='col-7 col-sm-7 col-md-7 col-lg-6 d-flex justify-content-center'>
            ...
            <div className='row g-2'>
                <div className='col-4 col-sm-5 col-md-5 col-lg-5'>
                    <div className='feature-2'>
                        <img src='/src/assets/ai.png' alt='AI Integration'/>
                    </div>
                </div>
                <div className='col-8 col-sm-7 col-md-7 col-lg-7 d-flex justify-content-center'>
                    <div className='feature-desc'>
            ...
            <div className='row g-2'>
                <div className='col-7 col-sm-7 col-md-7 col-lg-7 d-flex justify-content-center'>
                    <div className='feature-desc'>
