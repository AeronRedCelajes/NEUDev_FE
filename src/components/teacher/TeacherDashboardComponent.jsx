...
export const TeacherDashboardComponent = () => {
  ...
  const handleEditClass = (classItem, event) => {
    ...
    setEditClassData({
      ...
      // Load the stored cover image; if none exists, fallback to a default cover.
  ...
  const handleEditClassSave = async (e) => {
    ...
    // Call the updateClass API function with updated editClassData
          ...
          <div className='classes-container'>
            {classes.map((classItem, index) => (
              <Card className='class-card' key={index}
                ...
                {/* Use classCoverImage as the card image, fallback to default */}
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    if (file) {
                      setEditClassData({ 
                        ...editClassData, 
                        classCoverPhoto: file, // store the file object for upload
                        classCoverPreview: URL.createObjectURL(file) // set preview URL
                      });
                    }
                  }}
                />
